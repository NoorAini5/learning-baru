...
class DiskusiDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Diskusi $model)
    {
        return $model->select('diskusis.*')->with(['mapel']);
    }
