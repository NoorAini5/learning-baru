...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.master-data.kelas.update', $data->id) : route('admin.master-data.kelas.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
